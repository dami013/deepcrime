...
def main(model_name):
    ...
    if (not os.path.exists(model_location)):
        ...
        model.compile(loss=loss_operators.operator_change_loss_function(keras.losses.categorical_crossentropy), optimizer=keras.optimizers.Adadelta(learning_rate=1.0), metrics=['accuracy'])
