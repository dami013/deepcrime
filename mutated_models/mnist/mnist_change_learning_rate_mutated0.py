...
def main(model_name):
    ...
    if (not os.path.exists(model_location)):
        ...
        model.compile(loss=keras.losses.categorical_crossentropy, optimizer=hyperparams_operators.operator_change_learning_rate(keras.optimizers.Adadelta(learning_rate=1.0)), metrics=['accuracy'])
